# Winziger lokaler Webserver für Betriebskosten-Abrechner.
...
# Dann:   http://localhost:8124 im Browser öffnen. Beenden mit Strg+C.
...
$l.Start()
Write-Host "Betriebskosten-Abrechner laeuft auf $prefix  (Strg+C zum Beenden)"
